// src/data/accesorios-cablesAcero.js
const modules = import.meta.glob(
  './acc-cable-acero-tubos-aluminio*.{jpg,jpeg,png,webp,avif}'
);

import moneyAR from '../../../utils/money.js';

export const CATEGORY = 'accesorios-cables-acero-tubos-aluminio';
...
function makeGroup(item) {
  const rep = item.num;
  const name = `Cable de acero con tubo de aluminio ${rep}`;
