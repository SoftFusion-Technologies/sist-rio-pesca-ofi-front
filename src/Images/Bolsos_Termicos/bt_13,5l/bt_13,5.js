...
const modules = import.meta.glob('./bt_13,5_*.{jpg,jpeg,png,webp,avif}');

import moneyAR from '../../../utils/money.js';

export const CATEGORY = 'bolsos-termicos-bt-135';
...
function makeGroup(item) {
  const rep = item.num;
  const name = `Bolsos Termicos de 13,5 Litros ${rep}`;
