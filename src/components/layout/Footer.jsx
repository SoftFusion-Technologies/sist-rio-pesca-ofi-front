...
export default function Footer() {
  ...
  return (
    <footer
      className="relative mt-10 sm:mt-14 lg:mt-16 w-full"
      aria-label="Footer"
    >
      {/* Separador superior full width */}
      <div className="relative h-px w-full bg-white/10">
        <div className="absolute inset-x-0 -top-px h-[2px] bg-gradient-to-r from-transparent via-cyan-200/30 to-transparent" />
      </div>

      <div className="relative w-full pt-6 sm:pt-8 pb-0">
        <div
          className="relative w-full overflow-hidden rounded-none px-4 sm:px-5 lg:px-6 xl:px-8 py-4 sm:py-5 lg:py-6"
          style={{
            background:
              'linear-gradient(180deg, rgba(7,20,36,0.84), rgba(6,17,30,0.92))',
            borderTop: '1px solid rgba(255,255,255,0.10)',
            boxShadow:
              '0 -8px 40px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.03)',
              ...
              <div className="relative grid grid-cols-1 xl:grid-cols-[1.2fr_0.9fr_0.9fr] gap-4 sm:gap-5 lg:gap-6">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-2 inline-flex items-center gap-2 text-white/78 text-sm">
                        ...
                        <span>
                          {brand?.locationLabel || 'Río Seco - Tucumán'}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="mt-4 text-white/70 text-sm leading-relaxed">
                    Te asesoramos para elegir productos de pesca y camping según
                    tu salida, experiencia y presupuesto.
                  </p>
