...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../../Images/Bolsos_Termicos/bt_7,5l/bt_7,5l';
...
export default function FeaturedProductsbt_75({
  title = 'Productos - Bolsos Termicos - 7,5 Litros',
  initialBatch = 12,
  batchSize = 12
}) {
