...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../../Images/Bolsos_Termicos/Conservadora_Fishman_9l/bt_conservadora_fishaman';
...
export default function FeaturedProductsbt_ConservadoraFishman({
  title = 'Productos - Bolsos Térmicos - Conservadora FISHMAN',
  initialBatch = 12,
  batchSize = 12
}) {
