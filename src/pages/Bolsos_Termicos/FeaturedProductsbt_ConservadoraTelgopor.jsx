...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../../Images/Bolsos_Termicos/Conservadora_Telgopor/bt_conservadora_telgopor';
...
export default function FeaturedProductsbt_ConservadoraTelgopor({
  title = 'Productos - Bolsos Térmicos - Conservadora TELGOPOR',
  initialBatch = 12,
  batchSize = 12
}) {
