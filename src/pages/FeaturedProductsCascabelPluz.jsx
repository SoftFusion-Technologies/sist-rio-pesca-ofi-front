...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../Images/Accesorios/CascabelPluz/accesorios-cascabelPluz';
...
export default function FeaturedProductsCascabelPluz({
  title = 'Productos - Accesorios - Cascabel de Pluz',
  initialBatch = 12,
  batchSize = 12
}) {
