...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../Images/Accesorios/Esmerillones/accesorios-esmerillones';
...
export default function FeaturedProductsEsmerillones({
  title = 'Productos - Accesorios - Esmerillones',
  initialBatch = 12,
  batchSize = 12
}) {
