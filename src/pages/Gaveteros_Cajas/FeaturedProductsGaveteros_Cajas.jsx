...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../../Images/Gaveteros_Cajas/Gaveteros_Cajas';
...
export default function FeaturedProductsGaveteros_Cajas({
  title = 'Productos - Gaveteros y Cajas',
  initialBatch = 12,
  batchSize = 12
}) {
