...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../../Images/Indumentaria/Indumentaria';
...
export default function FeaturedProductsIndumentaria({
  title = 'Productos - Indumentaria',
  initialBatch = 12,
  batchSize = 12
}) {
