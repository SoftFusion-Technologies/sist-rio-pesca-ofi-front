...
import { ACCESORIOS_GROUP, loadPrimaryImage } from '../../Images/Reel_Frontales/ReelFrontales';
...
export default function FeaturedProductsReelFrontales({
  title = 'Productos - Reel Frontales',
  initialBatch = 12,
  batchSize = 12
}) {
